...
public class RegisterStepFourFragment extends Fragment {
    ...
    private EditText mLicence, mCar, mSeats, mRegistration, mCarNumber;
    private TextInputLayout mLicenceLayout, mCarLayout, mRegistrationLayout, mSeatsLayout, mCarNumberLayout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //instantiate objects
        mNextButton4 = mView.findViewById(R.id.nextBtn4);
        ...
        mCarNumberLayout = mView.findViewById(R.id.carNumberLayout);
        mCarNumber = mView.findViewById(R.id.carNumberStepFourEditText);
                ...
                switch (mCarToggle.getCheckedRadioButtonId()) {
                    case R.id.yesCarButton:
                        if (mLicence.getText().length() > 0 && mCar.getText().length() > 0
                                && mSeats.getText().length() > 0 && mRegistration.getText().length() > 0 && mCarNumber.getText().length() > 0) {
    ...
    public String getCarNumber() {
        return mCarNumber.getText().toString();
    }
