...
public class ProfileActivity extends AppCompatActivity {
    ...
    private TextView mDisplayUsername, mPersonalBio, mPhoneNumberTextView, mFullNameTextview, mReview1, mReview2, mReview3;
...
//        mReviewLayout.addView(textView3);
    ...
    private void setProfileWidgets(User userSettings){
        ...
        mFullNameTextview.setText(user.getFull_name());
        mPhoneNumberTextView.setText(user.getMobile_number().toString());
    }
