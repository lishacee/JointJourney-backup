...
import com.thang.jointjourney.Leaderboard.LeaderboardActivity;
import com.thang.jointjourney.Login.LoginActivity;
import com.thang.jointjourney.R;
import com.thang.jointjourney.Settings.SettingsActivity;
...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSettingsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(mContext, "Nút này sẽ cập nhập ở trong tương lai nếu qua được seminar nhé", Toast.LENGTH_SHORT).show();
...
//        leaderboards = (ImageView) findViewById(R.id.leaderboards);
    ...
    private void setProfileWidgets(User userSettings){
        ...
        mCompleteRides.setText(user.getCompletedRides() + " chuyến");
