package com.thang.jointjourney.Login;
...
import com.thang.jointjourney.Register.RegisterStepFourFragment;
import com.thang.jointjourney.Register.RegisterStepOneFragment;
import com.thang.jointjourney.Register.RegisterStepThreeFragment;
import com.thang.jointjourney.Register.RegisterStepTwoFragment;
import com.thang.jointjourney.Utils.FirebaseMethods;
import com.thang.jointjourney.Utils.NonSwipeableViewPager;
...
public class RegisterActivity extends AppCompatActivity implements RegisterStepOneFragment.OnButtonClickListener,
    ...
    private String username, password, email, fullName, dob, gender, profile_photo, licence_number, registration_plate, car,
            car_photo, education, work, bio, car_number;
    ...
    private void gatherData() {
        ...
        this.car_number = mRegisterStepFourFragment.getCarNumber();
    ...
    private void checkIfUsernameExists(final String username) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mFirebaseMethods.addNewUser(email, fullName, mUsername, profile_photo, mobileNumber, dob, licence_number, car, car_number, registration_plate, seats, work, bio, carOwner, gender, car_photo);

                Toast.makeText(mContext, "Đăng ký thành công, hãy đăng nhập ngay nào.", Toast.LENGTH_SHORT).show();
