        ...
        mBtn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isStringNull(email) && isStringNull(password)) {
                    Toast.makeText(mContext, "Hãy điền đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            try {
                                ...
                                //Toast.makeText(mContext, "isNew là" + isNew, Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(mContext, "Đăng nhập thất bại, sai email hoặc mật khẩu",
                                    Toast.LENGTH_SHORT).show();
                            updateUI(null);
