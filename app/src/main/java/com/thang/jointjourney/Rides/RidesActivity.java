package com.thang.jointjourney.Rides;
...
import com.thang.jointjourney.Adapter.MyAdapter;
...
import com.thang.jointjourney.Reminder.ReminderActivity;
import com.thang.jointjourney.Utils.BadgeView;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1) {
            if(resultCode == Activity.RESULT_OK){
                OfferRideCreatedDialog dialog = new OfferRideCreatedDialog(RidesActivity.this);
